...
export default {
  ...
  created: function () {
     ...
     this.backend_link = this.parent_backend+"/panoramas/"+this.parent_initialPano+"/"
  ...
  methods: {
    ...
    storeTag: function() {
        const update_url = this.parent_backend+"/image_objects/?";
        const component = this
    ...
    restoreImgObjs: function(type) { //type 1: tags; type 2: map spots
        ...
        switch(type) {
            case 1:
                retrieve_url = this.parent_backend+"/image_objects/?type="+ type.toString() +"&panorama="+this.pano_key;
                break;
            case 2:
                retrieve_url = this.parent_backend+"/image_objects/?type="+ type.toString();
                break;
        }
